                            ...
                            <form id="form-profile">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 mt-4 admin-input-group">
                                        ...
                                        <input type="text" class="form-control bg-dark text-danger font-monospace rounded-3 py-3 px-4 fw-bold" name="adminPassword" value="${profile.adminPassword || 'admin'}" required style="border: 1px solid rgba(255,50,50,0.2); box-shadow: inset 0 4px 10px rgba(0,0,0,0.5); letter-spacing: 2px;">
